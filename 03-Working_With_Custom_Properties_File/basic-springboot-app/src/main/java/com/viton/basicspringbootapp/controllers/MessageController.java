...
public class MessageController {
    ...
    @Autowired
    private ReadingCustomProperties properties;
    ...
    public String getCustomizedMessage(Model model){

       model.addAttribute("greetingsForTheDay", properties.getMessages() + userName); 
       return "home";
